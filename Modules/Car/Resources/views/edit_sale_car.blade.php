                                ...
                                <div class="col-12">
                                    ...
                                    <div class="crancy-product-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    <label class="crancy__item-label">{{ __('daily_price') }} </label>
                                                    <input class="crancy__item-input" type="text" name="daily_price" id="daily_price" value="{{ old('daily_price') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    <label class="crancy__item-label">{{ __('weekly_price') }} </label>
                                                    <input class="crancy__item-input" type="text" name="weekly_price" id="weekly_price" value="{{ old('weekly_price') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    <label class="crancy__item-label">{{ __('monthly_price') }} </label>
                                                    <input class="crancy__item-input" type="text" name="monthly_price" id="monthly_price" value="{{ old('monthly_price') }}">
                                                </div>
                                            </div>
