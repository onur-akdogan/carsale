                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="add-listing-car">
                                        ...
                                        <div class="add-listing-car-btn">
                                            @if ($kyc->status == 0)
                                                <a class="thm-btn-two">
                                                    <div class="homec-dashboard-property__label">
                                                        {{ __('translate.Pending') }}</div>
                                                </a>
                                            @endif
                                            @if ($kyc->status == 1)
                                                <a class="thm-btn-two">
                                                    <div class="homec-dashboard-property__label">
                                                        {{ __('translate.Approved') }}</div>
                                                </a>
                                            @endif
                                            @if ($kyc->status == 2)
                                                <a class="thm-btn-two">
                                                    <div class="homec-dashboard-property__label">
                                                        {{ __('translate.Reject') }}</div>
                                                </a>
                                            @endif
                                        </div>
                                    </div>
                                                ...
                                                <div class="car-images">
                                                    ...
                                                    <div class="car-images-inner">
                                                        <div class="description-item-inner">
                                                            <label for="brand"
                                                                class="form-label">{{ __('translate.Select Type') }}
                                                                <span>*</span> </label>
                                                        ...
                                                        <div class="car-images">
                                                            <div class="car-images-inner">
                                                                <h6 class="car-images-inner-txt">
                                                                    {{ __('translate.Upload New Image') }} <span>*</span>
                                                                </h6>
                                                                    ...
                                                                    <div class=" col-xl-6 col-lg-6">
                                                                        <div class="car-images-inner-item two">
                                                                            <div class="car-images-inner-item-thumb">
                                                                                <img src="{{ asset($setting->placeholder_image) }}"
                                                                                    id="thumb_image">
                                                                            </div>

                                                                            <div class="choose-file-txt">
                                                                                <h6>{{ __('translate.New') }}
                                                                                    <span>{{ __('translate.Choose File') }}</span>
                                                                                    {{ __('translate.Upload') }}</h6>
                                                        ...
                                                        <div class="description-item two">
                                                            ...
                                                            <div class="description-item-inner">
                                                                <label for="offer_price"
                                                                    class="form-label">{{ __('translate.Description') }}
                                                                    <span>*</span>
                                                                </label>
