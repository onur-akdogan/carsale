                    ...
                    <div class="inner-banner-df">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ __('translate.Car Details') }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="col-lg-8 col-md-7">
                        ...
                        @if ($listing_ads->status == 'enable')
                            <div class="inventory-details-thumb" data-aos="fade-up" data-aos-delay="50">
                                <a href="{{ $listing_ads->link }}" target="_blank"> <img
                                        src="{{ getImageOrPlaceholder($listing_ads->image, '950x130') }}"
                                        alt="img"></a>
                            </div>
                        @endif
                ...
                <div class="tab-content" id="priceTabContent">
                    ...
                    <div class="tab-pane fade show active" id="daily" role="tabpanel" aria-labelledby="daily-tab">
                        <ul class="key-information">
                            <li><span><strong>{{ __('Daily Price') }}:</strong></span> {{ currency($car->daily_price ?? 'N/A') }}</li>
                         </ul>
                    </div>
                    ...
                    <div class="tab-pane fade" id="weekly" role="tabpanel" aria-labelledby="weekly-tab">
                        <ul class="key-information">
                            <li><span><strong>{{ __('Weekly Price') }}:</strong></span> {{ currency($car->weekly_price ?? 'N/A') }}</li>
                         </ul>
                    </div>
                    ...
                    <div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly-tab">
                        <ul class="key-information">
                            <li><span><strong>{{ __('Monthly Price') }}:</strong></span> {{ currency($car->monthly_price ?? 'N/A') }}</li>
                         </ul>
                    </div>
                </div>
                <!-- Tabs Bitiş -->
                                                            ...
                                                            <svg class="svg-stock" width="18" height="18"
                                                                ...
                                                                <g mask="url(#mask0_390_111658)">
                                                                    ...
                                                                    <path d="M11.9043 8.8125H12.2551" stroke-width="0.6"
                                                                        stroke-miterlimit="10" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                    <path d="M11.9043 11.0734H12.2551" stroke-width="0.6"
                                                                        stroke-miterlimit="10" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                    <path d="M11.9043 13.3342H12.2551" stroke-width="0.6"
                                                                        stroke-miterlimit="10" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                    <path
                        ...
                        <div class="accordion aos-init aos-animate" id="accordionPanelsStayOpenExample2"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="locations">
                                            <li>
                                                ...
                                                <iframe src="{{ html_decode($car->google_map) }}" allowfullscreen=""
                        ...
                        @if ($reviews->count() > 0)
                            <!-- Write Your Review -->
                            <div class="accordion aos-init aos-animate" id="accordionPanelsStayOpenExample5"
                                                ...
                                                <div class="reviews">
                                                    <div class="reviews-item">
                                                        ...
                                                        <ul class="icon">
                                                            @for ($i = 1; $i <= 5; $i++)
                                                                @if ($review->rating < $i)
                                                                    <li><span><i class="fa-regular fa-star"></i></span>
                                                                    </li>
                                                                @else
                        ...
                        <div class="accordion aos-init aos-animate" id="accordionPanelsStayOpenExample6"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="write-your-review-item">
                                            <div class="write-your-review-stars">
                                                <ul class="icon">
                                                    <li><i onclick="carReview(1)" data-rating="1"
                                                            class="car_rat fa-solid fa-star"></i></li>
                                                    <li><i onclick="carReview(2)" data-rating="2"
                                                            class="car_rat fa-solid fa-star"></i></li>
                                                    <li><i onclick="carReview(3)" data-rating="3"
                                                            class="car_rat fa-solid fa-star"></i></li>
                                                    <li><i onclick="carReview(4)" data-rating="4"
                                                            class="car_rat fa-solid fa-star"></i></li>
                                                    <li><i onclick="carReview(5)" data-rating="5"
                                                            class="car_rat fa-solid fa-star"></i></li>
                                            ...
                                            <form method="POST" action="{{ route('user.store-review') }}">
                                                ...
                                                <div class="form-item">
                                                    <div class="form-inner">
                                                        <label class="form-label">{{ __('translate.Review') }}
                                                            <span>*</span> </label>
                                                        <textarea name="comment" class="form-control" id="review" rows="5"
                                                            placeholder="{{ __('translate.Write here') }}"></textarea>
                                                    </div>
                                                ...
                                                <button type="submit"
                                                    class="thm-btn-two">{{ __('translate.Submit Review') }}</button>
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="p-sticky">
                            <div class="auto-sales-item">
                                ...
                                <div class="auto-sales-item-inner">
                                    ...
                                    <div class="auto-sales-logo">
                                        <a href="{{ route('dealer', $dealer->username) }}"><img
                                    ...
                                    <div class="auto-sales-text-item">
                                        <div class="auto-sales-text-left">
                                            ...
                                            <p>{{ __('translate.Member Since') }} {{ $dealer->created_at->format('F Y') }}
                                            </p>
                                        </div>
                                        <div class="auto-sales-text-right">
                                            ...
                                            <p>
                                                <span>
                                                    <svg width="53" height="11" viewBox="0 0 53 11"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                 ...
                                 <div class="auto-sales-contact">
                                    <ul>
                                        ...
                                        <form action="{{ route('requests.store') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="dealer_id" value=" {{ $car?->id }}">
                                            <input type="hidden" name="request_id" value="{{  $dealer->id }}">
                                    ...
                                    <div class="auto-sales-form">
                                        ...
                                        <div class="auto-sales-form-item">
                                            <input type="email" class="form-control" id="exampleFormControlInput4"
                                                placeholder="{{ __('translate.Email') }} *" name="email"
                                                value="{{ old('email') }}">
                                        </div>

                                        <div class="auto-sales-form-item">
                                            <input type="text" class="form-control" id="exampleFormControlInput5"
                                                placeholder="{{ __('translate.Phone') }}" name="phone"
                                                value="{{ old('phone') }}">
                                        </div>
                                        ...
                                        <button type="submit"
                                            class="thm-btn-two">{{ __('translate.Send Message') }}</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="auto-lone-item">
                                ...
                                <p class="sub-taitel">
                                    {{ __('translate.You can calculate monthly loan amount using this calculator') }}
                                </p>
                                ...
                                <form>
                                    <div class="auto-lone-form">
                                            ...
                                            <div class="icon">
                                                <span>
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="12" cy="12" r="10" stroke="#405FF2"
                                                            stroke-width="1.5" />
                                                        <path
                                                            d="M14 10C14 8.89543 13.1046 8 12 8C10.8954 8 10 8.89543 10 10C10 11.1046 10.8954 12 12 12"
                                                            stroke="#405FF2" stroke-width="1.5" stroke-linecap="round" />
                                                        <path
                                                            d="M12 12C13.1046 12 14 12.8954 14 14C14 15.1046 13.1046 16 12 16C10.8954 16 10 15.1046 10 14"
                                                            stroke="#405FF2" stroke-width="1.5" stroke-linecap="round" />
                                                        <path d="M12 6.5V8" stroke="#405FF2" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M12 16V17.5" stroke="#405FF2" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                            </div>
                                                ...
                                                <span>
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <circle cx="2" cy="2" r="2"
                                                            transform="matrix(1 0 0 -1 14 18)" stroke="#405FF2"
                                                            stroke-width="1.5" />
                                                        <circle cx="2" cy="2" r="2"
                                                            transform="matrix(1 0 0 -1 6 10)" stroke="#405FF2"
                                                            stroke-width="1.5" />
                                                        <path d="M19 5L4 20" stroke="#405FF2" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                            </div>
                                                ...
                                                <span>
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#405FF2" stroke-width="1.5" />
                                                        <path d="M3 9H21" stroke="#405FF2" stroke-width="1.5"
                                                            stroke-linecap="round" />
                                                        <path d="M8 2L8 5" stroke="#405FF2" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M16 2V5" stroke="#405FF2" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                        ...
                                        <div class="auto-lone-form-btn">
                                            <button id="calculate_btn" type="button"
                                        ...
                                        <p class="auto-lone-amount">{{ __('translate.Monthly Payment') }}: <span
                                                id="monthly_payment">{{ currency(0.0) }}</span></p>
                                        ...
                                        <div class="taitel-img">
                                            <span>
                                                <svg width="100" height="8" viewBox="0 0 100 8" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.5C14.3957 2.77999 52.7496 -2.53808 99 6.38995"
                                                        stroke="#405FF2" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="brand-car-item">
                                            <div class="brand-car-item-img">
                                                <img src="{{ getImageOrPlaceholder($related_car->thumb_image, '304x217') }}"
                                                    alt="thumb">
                                                ...
                                                <div class="brand-car-item-img-text">
                                                    ...
                                                    <div class="text-df">
                                                        @if ($related_car->offer_price)
                                                            <p class="text">
                                                                {{ calculate_percentage($related_car->regular_price, $related_car->offer_price) }}%
                                                                {{ __('translate.Off') }}</p>
                                                        @endif
                                                    ...
                                                    <div class="icon-main">
                                                        ...
                                                        @else
                                                            <a href="{{ route('user.add-to-wishlist', $related_car->id) }}"
                                                                class="icon">
                                                                <span>
                                                                    <svg width="18" height="16" viewBox="0 0 18 16"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="brand-car-inner">
                            ...
                            <div class="brand-car-btm-txt-btm">
                                <h6 class="brand-car-btm-txt"><span>{{ __('translate.Listed by') }}
                                        :</span>{{ html_decode($related_car?->dealer?->name) }}
                                </h6>
                            </div>
                        </div>
